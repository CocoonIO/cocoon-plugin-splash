...
#define kSplashScreenDurationDefault 3000
#define kSplashScreenBackgroundColorDefault @"#1c2023"

#define SPLASH_SCALE_MODE @"DefaultCocoonSplashScaleMode"
#define SPLASH_BACKGROUND_COLOR @"DefaultCocoonSplashBackgroundColor"
#define SPLASH_DELAY @"DefaultCocoonSplashDelay"
#define SPLASH_PADDING @"DefaultCocoonSplashPadding"
...
- (void)showSplash {
    ...
    _imageView.backgroundColor = [SplashPlugin UIColorFromHTMLColor:splashBackgroundColor];
...
- (UIImage*)getSplashView {
    NSData* data = [NSData dataWithBytes:splash_image length:sizeof(splash_image)];
    ...
    if ([splashPadding containsString:@"%"]) {
        NSUInteger index = [splashPadding rangeOfString:@"%" options:NSBackwardsSearch].location;
        padding = [[splashPadding substringToIndex:index] floatValue];
    ...
    CGContextSetFillColorWithColor(context, [[SplashPlugin UIColorFromHTMLColor:splashBackgroundColor] CGColor]);
